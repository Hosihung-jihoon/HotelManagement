...
// Luxury hotel images
const HERO_BG = 'https://images.unsplash.com/photo-1566073771259-6a8506099945?w=1920&q=85'; // Luxury hotel lobby
const ABOUT_IMG = 'https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?w=900&q=80'; // Hotel exterior
      ...
      <section className={styles.hero} style={{ backgroundImage: `url(${HERO_BG})` }}>
        ...
        <div className={['container', styles.heroContent].join(' ')}>
          <div className={styles.heroText}>
            <p className={['label-lg', styles.heroEyebrow].join(' ')}>HotelManagement</p>
            <h1 className={['display-lg', styles.heroHeadline].join(' ')}>
              Trải Nghiệm Sang Trọng<br />
        ...
        <div className="container">
          <div className={styles.aboutGrid}>
            <div className={styles.aboutImgWrap}>
              <img src={ABOUT_IMG} alt="HotelManagement exterior" className={styles.aboutImg} loading="lazy" />
            ...
            <div className={styles.aboutText}>
              ...
              <p className={['body-lg', styles.aboutDesc].join(' ')}>
                HotelManagement không chỉ là nơi lưu trú — đây là một trải nghiệm sống.
