...
public class RoomService : IRoomService
{
    ...
    private readonly Microsoft.AspNetCore.SignalR.IHubContext<HotelManagement.API.Hubs.RoomHub> _hubContext;

    public RoomService(IRoomRepository repository, Microsoft.AspNetCore.SignalR.IHubContext<HotelManagement.API.Hubs.RoomHub> hubContext)
    {
    ...
    public async Task<(bool success, string? error)> UpdateAsync(int id, UpdateRoomDto dto)
    {
        ...
        await _hubContext.Clients.All.SendAsync("ReceiveRoomStatusUpdate", entity.Id, entity.Status);
